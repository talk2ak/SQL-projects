...
/*  For a Consumer Goods company, Sales Data Analysis was performed using User Defined Function and Stored Procedures.

Problem 1:

Here, an Aggregate monthly sales report is generated for croma india customer (customer_code = 90002002). so that we can track how much sales 
this particular customer is generating.

Task 1: The report fields 1. Month, 2. Product name, 3. Variant, 4. Sold Quantity, 5. Gross price per Item, 6. Gross price Total 

Task 2: The report fields: 1. Month, 2. Total gross sales amount to croma india this month.
...
# Similarly, Writing a Quarter user defined function -
...
# getting details from product table using above functions
...
# Yearly Sales Report --> Yearly sales report for Croma India where there are two columns:
-- 1. Fiscal Year
...
-- Now, we can extract any data for a given customer code and checking it.
